...
<div class="row">
    <div class="col-12 col-lg-8 col-xxl-8 d-flex">
        <div class="card flex-fill">
            <div class="card-header">
                <h5 class="card-title mb-0">Users List <button class="btn btn-dark btn-sm float-end btnAdd" data-bs-toggle="modal" data-bs-target="#formUserModal">Create New User</button></h5>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            <?php foreach ($Users as $users) : ?>
                                <tr>
                                    ...
                                    <td><span class="badge bg-secondary"><?= $users['role_name']; ?></span></td>
    ...
    <div class="col-12 col-lg-4 col-xxl-4 d-flex">
        <div class="card flex-fill">
            <div class="card-header">
                <h5 class="card-title mb-0">User Roles <button class="btn btn-dark btn-sm float-end btnAddRole" data-bs-toggle="modal" data-bs-target="#formRoleModal">Create New Role</button></h5>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        $(".btnEdit").click(function() {
            ...
            $('.modal-content form').attr('action', '<?= base_url('users/update') ?>');
            $('#userID').val(userId);
