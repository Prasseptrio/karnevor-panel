				...
				<div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
					<div class="mt-3">
						<div class="row">
							...
							<div class="col-6">
								<h5 class="fw-bold text-dark">Create New Menu Category</h5>
								<hr>
								<form action="<?= base_url('menu-management/create-menu-category'); ?> " method="post">
									...
									<div class="text-end">
										<button class="btn btn-dark ">Save Menu Category</button>
									</div>
								</form>
							</div>
						</div>
				...
				<div class="tab-pane fade" id="menu" role="tabpanel" aria-labelledby="menu-tab">
					<div class="mt-3">
						<div class="row">
							...
							<div class="col-sm-6">
								<h5 class="fw-bold text-dark">Create New Menu</h5>
								<hr>
								<form action="<?= base_url('menu-management/create-menu'); ?>" method="post">
									...
									<div class="text-end mt-3">
										<button class="btn btn-dark ">Save Menu</button>
									</div>
								</form>
							</div>
						</div>
				...
				<div class="tab-pane fade" id="submenu" role="tabpanel" aria-labelledby="submenu-tab">
					<div class="mt-3">
						<div class="row">
							...
							<div class="col-sm-6">
								<h5 class="fw-bold text-dark">Create New Submenu</h5>
								<hr>
								<form action="<?= base_url('menu-management/create-submenu'); ?>" method="post">
									...
									<div class="text-end">
										<button class="btn btn-dark">Save Submenu</button>
									</div>
								</form>
							</div>
						</div>
