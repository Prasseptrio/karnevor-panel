...
<div class="row">
    <div class="col-12 col-lg-4 col-xxl-4 d-flex">
        <div class="card flex-fill">
            ...
            <div class="card-body">
                <form action="<?= base_url('crud-generator'); ?> " method="get">
                    ...
                    <div class="d-grid gap-2 mt-3">
                        <button class="btn btn-dark" type="submit">Generate Code</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    {
        $create<?= $functionName; ?> = $this-&gt;<?= $modelName; ?>Model-&gt;create<?= $functionName; ?>($this->request->getPost(null));
        ...
        {
            $update<?= $functionName; ?> = $this-&gt;<?= $modelName; ?>Model-&gt;update<?= $functionName; ?>($this-&gt;request-&gt;getPost(null));
